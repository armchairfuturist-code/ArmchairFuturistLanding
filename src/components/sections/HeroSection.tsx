        ...
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 xl:gap-16 items-center">
          <div className="flex flex-col justify-center space-y-6">
            ...
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <Button asChild variant="outline" size="lg" className="shadow-lg transition-transform duration-200 hover:scale-105 border-primary-foreground/70 text-primary-foreground hover:bg-primary-foreground/10">
