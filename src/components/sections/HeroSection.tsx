		...
		>
			...
			<div className="sr-only" aria-hidden="true">
				...
				<div itemProp="description">
					Alex Myers is a partner in learning for individuals and teams. We
					build mental models for how AI works and test them live on real work.
					He also builds the systems when you’d rather have it built. 40+ AI
					systems deployed. Clients reclaim 10-20 hours per week.
				</div>
			</div>
			{/* Subtle sky-blue atmospheric tint — solid tint per DESIGN.md (no gradients) */}
			<div
				className="absolute inset-0 bg-hp-soft/[0.08] pointer-events-none"
				aria-hidden="true"
			/>
				...
				<div className="flex flex-col space-y-8 text-center">
					...
					>
						<BlurFade delay={0.05} inView duration={prefersReduced ? 0 : 0.4}>
							<p className="relative inline-flex items-center gap-2 font-mono text-xs uppercase tracking-[0.4em] text-hp-electric md:text-hp-electric mb-4 md:mb-5">
              ...
              Connect section and the result page for one consistent promise. */}
						...
						<div className="flex flex-col items-center gap-4">
							<div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap">
								<BookCallButton
									...
									size="lg"
									icon="calendar-days"
									className="px-7 py-3 text-base uppercase tracking-[0.7px]"
								>
								...
								<a
									...
									className="inline-flex items-center gap-2 text-primary font-medium text-base px-7 py-3 rounded border border-primary/20 hover:bg-primary/5 hover:border-primary/40 active:scale-[0.96] transition-[background-color,border-color,color] duration-200"
								>
					...
					<BlurFade delay={0.55} inView>
						<div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-sm text-charcoal">
							...
							<span>
								<strong className="text-ink">hundreds of hours</strong> of
								coaching delivered
							</span>
							<span className="hidden sm:inline text-hairline-strong">·</span>
							<span>
								<strong className="text-ink">10–20 hrs/week</strong> reclaimed
								per client
							</span>
						</div>
					</BlurFade>
