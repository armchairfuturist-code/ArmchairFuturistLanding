				...
				<BlurFade inView>
					<div className="text-center mb-12">
						...
						<p className="text-muted-foreground text-lg max-w-2xl mx-auto">
							...
							test them live on your real work. You leave with judgment you
							keep.
						</p>
					</div>
				</BlurFade>
				...
				<BlurFade inView>
					<div className="text-center mb-6">
						...
						<p className="text-muted-foreground max-w-xl mx-auto mb-4">
							All sessions are 60 minutes, held via video call. Pick the
							commitment that fits your goals.
						</p>
							...
							>
								<div className="p-5 flex flex-col flex-1">
									...
									<BookCallButton
										...
										trackOnClick={false}
										onClick={() =>
											trackConversion(`guidance_${pkg.id}`, pkg.totalPrice)
										}
						...
						<summary className="cursor-pointer list-none flex items-center justify-between gap-4 px-6 py-5 hover:bg-secondary/40 transition-colors">
							<div>
								...
								<p className="text-base font-semibold text-foreground">
									Side-by-side: Single, 5, 10, and 20-session packs
								</p>
							</div>
