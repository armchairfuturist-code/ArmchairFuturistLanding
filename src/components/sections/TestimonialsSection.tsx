...
export default function TestimonialsSection() {
	...
	return (
		<section
			id="testimonials"
			className="py-12 md:py-24 bg-secondary scroll-mt-20 overflow-hidden"
		>
			<BlurFade inView>
				<div className="container mx-auto px-4 md:px-6 text-center mb-12">
					...
					<p className="mt-3 text-muted-foreground font-sans text-base max-w-xl mx-auto">
						Testimonials from executives, founders, and operators across tech,
			...
			<div className="relative">
				...
				<p className="absolute bottom-2 right-4 z-10 text-xs text-muted-foreground/40 font-mono pointer-events-none select-none">
					hover to pause
				</p>
				<Marquee
					pauseOnHover
