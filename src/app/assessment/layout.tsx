...
export const metadata: Metadata = {
  ...
  description:
    'Take the free 10-question AI readiness assessment. Get a personalized diagnosis of your clarity, readiness, and urgency, with a recommendation that matches where you actually are.',
  alternates: {
