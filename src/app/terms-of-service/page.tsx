    ...
    <div className="container mx-auto py-12 px-4 md:px-6">
      <Card className="max-w-3xl mx-auto shadow-lg">
        ...
        <CardContent className="prose prose-lg max-w-none text-foreground/80">
          ...
          <p>
            The AI Email Introduction tool generates content based on user inputs and AI models. While we strive for accuracy and relevance, we do not guarantee the suitability, reliability, or accuracy of the generated content. You are solely responsible for reviewing and using any AI-generated content in compliance with all applicable laws and ethical standards. Alex Myers Consulting LLC is not liable for any consequences arising from the use of AI-generated content.
          </p>
