    ...
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <section className="mb-16">
        ...
        <ul className="space-y-6">
          <li><strong>Daily AI Digest</strong> — 11:00. HuggingNews, HN, arXiv, Reddit. 2,500-3,000 words in my voice. Published to Substack and the blog.</li>
          <li><strong>LinkedIn Post</strong> — 12:00. Under 3,000 characters. Business-focused takeaways.</li>
          <li><strong>Morning Dojo Report</strong> — 06:00. System health, cron integrity, git status. Scannable.</li>
          <li><strong>End-of-Day Summary</strong> — 18:00. What shipped, what failed, what's tomorrow.</li>
