    ...
    <div className="min-h-[100dvh] bg-background">
      <div className="container mx-auto px-4 md:px-6 py-6">
        ...
        <nav aria-label="Systems" className="mt-4 flex flex-wrap gap-x-5 gap-y-2 text-sm font-sans">
          <Link href="/services/data-foundation" aria-current="page" className="font-semibold text-foreground">
            Data Foundation
          </Link>
        ...
        <div className="container mx-auto px-4 md:px-6 max-w-4xl">
          ...
          <div className="p-6 rounded-xl border border-border/60 bg-card mb-10">
            <ul className="space-y-2 text-foreground/80 text-sm leading-relaxed">
              <li>· No one can own it. The system needs one named owner and one hour a week.</li>
              <li>· You want a migration project. This wires the tools you already have.</li>
            </ul>
          </div>
          <h2 className="font-heading text-2xl font-bold text-foreground mb-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            <details className="p-5 rounded-xl border border-border/60 bg-card">
              <summary className="font-semibold text-foreground cursor-pointer">How long does a Data Foundation take?</summary>
              <p className="mt-2 text-sm text-foreground/80 leading-relaxed">One to two weeks after the audit. Top 20 SOPs first, then the rest.</p>
            </details>
            <details className="p-5 rounded-xl border border-border/60 bg-card">
              <summary className="font-semibold text-foreground cursor-pointer">What do you need from us?</summary>
              <p className="mt-2 text-sm text-foreground/80 leading-relaxed">Access to Sheets, Drive, and inbox, plus one operator interview. No migration project.</p>
            </details>
            <details className="p-5 rounded-xl border border-border/60 bg-card">
              <summary className="font-semibold text-foreground cursor-pointer">What if our SOPs are messy?</summary>
              <p className="mt-2 text-sm text-foreground/80 leading-relaxed">We structure the top 20 first. The rest follows the same template.</p>
            </details>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-secondary">
        <div className="container mx-auto px-4 md:px-6 max-w-3xl text-center">
          <div>
            <h2 className="font-heading text-3xl font-bold text-foreground mb-4">Start with the Blueprint</h2>
